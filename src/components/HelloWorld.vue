<template>
  ...
  2xl:flex 2xl:items-center 2xl:justify-center 2xl:flex-col 2xl:w-full
 ">
      ...
      2xl:w-full 2xl:h-20 2xl:grid 2xl:place-items-center
      ">
        ...
        2xl:text-white 2xl:text-5xl 2xl:font-semibold
        ">DOLAR AHORA</h1>
      </div>
      ...
      2xl:w-full 2xl:flex 2xl:flex-wrap 2xl:justify-center 2xl:items-center
      ">
        ...
        2xl:w-72 2xl:ml-10 2xl:mr-10 2xl:h-64 2xl:border-black 2xl:shadow-md 2xl:shadow-black 2xl:border-2 2xl:rounded-2xl 2xl:bg-gray-900 2xl:mt-5 2xl:mb-5 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center
        " v-for="tipos in dolares" :key="tipos.id">
            ...
            2xl:text-center 2xl:mt-4
            ">
              <h3 class="text-red-600">Venta</h3>
              <h3 class="text-red-600 font-semibold cel:text-2xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-3xl">${{ tipos.venta }}</h3>
            </div>
            <div v-if="!tipos.compra == ''" class="text-center cel:mt-2 sm:mt-2 md:mt-3 lg:mt-4 xl:mt-4 2xl:mt-4">
              <h3 class="text-green-600">Compra</h3>
              <h4 class="text-green-600 font-semibold cel:text-2xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-3xl">${{ tipos.compra }}</h4>
            </div>
            <div class="text-center cel:mt-3 sm:mt-3 2xl:text-center">
                <h6 v-if="dolares.length > 0" class="cel:text-xs text-white sm:text-base  md:text-xs md:mt-1 md:mb-1 mt-2 mb-2 lg:text-sm xl:text-sm 2xl:text-sm">Ultima actualización: {{
